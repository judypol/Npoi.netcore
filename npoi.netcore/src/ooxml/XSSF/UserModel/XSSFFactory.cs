    ...
    public class XSSFFactory : POIXMLFactory
    {
        ...
        public override POIXMLDocumentPart CreateDocumentPart(POIXMLDocumentPart parent, PackageRelationship rel, PackagePart part)
        {
            ...
            try
            {
                ...
                //ConstructorInfo constructor = cls.GetTypeInfo().GetConstructor(BindingFlags.NonPublic | BindingFlags.Instance,null, new Type[] { typeof(PackagePart), typeof(PackageRelationship) },null);
                ConstructorInfo constructor =
                    cls.GetTypeInfo().GetConstructor(new Type[] {typeof(PackagePart), typeof(PackageRelationship)});
